...
import { Phone, MapPin, Clock, PawPrint, Heart, Shield, Star, MessageCircle } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ ease: easeOut }}>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              با بیش از ۷ سال تجربه در حوزه گرومینگ و مراقبت حیوانات خانگی، ما بهترین خدمات را برای دوستان کوچک شما ارائه می‌دهیم
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="clay-card p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { icon: Heart, text: "محیط آرام و مجهز مخصوص حیوانات" },
              ...
              <div className="rounded-2xl overflow-hidden bg-gradient-to-br from-primary/5 to-amber-50 aspect-square flex items-center justify-center">
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-transparent via-secondary/20 to-transparent">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <p className="text-muted-foreground mb-4">سوالی دارید؟ با ما در ارتباط باشید</p>
            <a href="https://wa.me/989120000000" target="_blank" rel="noopener noreferrer"
              className="clay-btn bg-emerald-600 text-white px-8 py-3 font-bold inline-flex items-center gap-2">
