        ...
        <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 14px rgba(0,0,0,0.1);">
          ...
          <div style="padding: 30px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              ...
              ${args.petBreed ? `<tr><td style="padding: 8px 0; color: #666;">نژاد:</td><td style="padding: 8px 0; font-weight: bold;">${args.petBreed}</td></tr>` : ""}
              ...
              <tr><td style="padding: 8px 0; color: #666;">خدمت:</td><td style="padding: 8px 0; font-weight: bold;">${args.serviceName}</td></tr>
              ...
              <tr><td style="padding: 8px 0; color: #666;">هزینه:</td><td style="padding: 8px 0; font-weight: bold; color: #C4703A; font-size: 18px;">${args.servicePrice.toLocaleString("fa-IR")} تومان</td></tr>
    ...
    try {
      const response = await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          ...
          to: [adminEmail],
          subject: `🐾 رزرو جدید: ${args.petName} - ${args.serviceName}`,
          html: htmlContent,
        }),
      });
